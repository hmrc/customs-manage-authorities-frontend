...
import models.domain.{
  ...
  CdsCashAccount, DutyDefermentAccount, DutyDefermentBalance, GeneralGuaranteeAccount, GeneralGuaranteeBalance,
  StandingAuthority
}
...
class EditCheckYourAnswersValidationServiceSpec extends SpecBase {
  "validate" must {
    "return StandingAuthority" when {
      "EditAuthorityEndPage has Setdate" in new SetUp {
        ...
        running(application) {
          service.validate(userAnswers, accountIdVal, authorityIdVal, eoriVal) mustBe Option(
            StandingAuthority(
              eoriVal,
      ...
      "EditAuthorityStartPage has Setdate" in new SetUp {
        ...
        val tempUserAnswers = userAnswers
          .remove(EditAuthorityStartPage(accountIdVal, authorityIdVal))
          .success
          .value
          .set(EditAuthorityStartPage(accountIdVal, authorityIdVal), AuthorityStart.Setdate)(AuthorityStart.writes)
          .success
          .value
          .remove(EditAuthorityEndDatePage(accountIdVal, authorityIdVal))
          .success
          .value
          .set(EditAuthorityStartDatePage(accountIdVal, authorityIdVal), LocalDate.of(yearVal, monthVal, dayOfMonthVal))
          .success
          .value
        ...
        running(application) {
          service.validate(tempUserAnswers, accountIdVal, authorityIdVal, eoriVal) mustBe None
        }
      }
    }
    ...
    "return None" when {
      "EditAuthorityEndPage is set to Indefinite and ShowBalance is not set in UserAnswers" in new SetUp {
        ...
        running(application) {
          service.validate(userAnswersWithAuthorityEndIndefinite, accountIdVal, authorityIdVal, eoriVal) mustBe empty
        }
      }
    }
  ...
  trait SetUp {
    ...
    val userAnswers: UserAnswers = UserAnswers("id")
      ...
      .success
      .value
      .set(EoriNumberPage, CompanyDetails(eoriVal, Some("companyName")))
      .success
      .value
      .set(EditAuthorityStartPage(accountIdVal, authorityIdVal), AuthorityStart.Today)(AuthorityStart.writes)
      .success
      .value
      .set(EditAuthorityEndPage(accountIdVal, authorityIdVal), AuthorityEnd.Setdate)(AuthorityEnd.writes)
      .success
      .value
      .set(EditAuthorityEndDatePage(accountIdVal, authorityIdVal), LocalDate.of(yearVal, monthVal, dayOfMonthVal))
      .success
      .value
      .set(EditShowBalancePage(accountIdVal, authorityIdVal), ShowBalance.Yes)(ShowBalance.writes)
      .success
      .value
    ...
    val userAnswersWithAuthorityEndIndefinite: UserAnswers = UserAnswers("id")
      ...
      .success
      .value
      .set(EditAuthorityEndPage(accountIdVal, authorityIdVal), AuthorityEnd.Indefinite)(AuthorityEnd.writes)
      .success
      .value
      .set(EditAuthorityEndDatePage(accountIdVal, authorityIdVal), LocalDate.of(yearVal, monthVal, dayOfMonthVal))
      .success
