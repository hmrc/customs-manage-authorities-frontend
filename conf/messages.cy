...
error.nonNumeric=Rhowch werth gan ddefnyddio rhifau yn unig
...
eoriNumber.hint.xi=Mae’r rhif EORI yn dechrau gyda GB neu XI wedi’i ddilyn gan 12 digid neu GBN wedi’i ddilyn gan 11 digid. <br>Er enghraifft, GB345834921000, XI345834921000 neu GBN10537914000.
...
showBalance.checkYourAnswers.no=Na
...
checkYourAnswers.showBalance.hidden=Opsiwn i weld y balans
checkYourAnswers.fullName.hidden = Eich enw
checkYourAnswers.role.hidden = Eich swydd
checkYourAnswers.companyDetails.h2 = Cwmni awdurdodedig
checkYourAnswers.authorityDetails.h2 = Manylion yr awdurdod
...
remove.fullName=Enw llawn
remove.error.fullName.required=Nodwch eich enw llawn
remove.error.fullName.length=Mae’n rhaid i’ch enw llawn fod yn 255 o gymeriadau neu lai
remove.error.fullName.malicious = Mae’n rhaid i’r enw llawn beidio â chynnwys cromfachau, arwyddion doler na slaesau
remove.jobRole=Swydd
remove.error.jobRole.required=Nodwch eich swydd
