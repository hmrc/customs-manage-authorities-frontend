...
import utils.StringUtils.{comma, emptyString}
...
trait Formatters {
  ...
  private[mappings] def enumerableFormatter[A](requiredKey: String,
                                               invalidKey: String)(implicit ev: Enumerable[A]): Formatter[A] =
    new Formatter[A] {
